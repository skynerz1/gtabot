...
$mention = $user_id ? "[$name](tg://user?id=$user_id)" : $name;
    ...
    // كلمات محظورة
    $banned = ["اكسزعيم", "كيلوا", "جنتل", "fsgta", "xz3eem", "بايو", "@YYYYF", "bio" ,"احبك" , "اكس زعيم","كسمك","قحبه"];
...
$groups = [
    ...
    "-1002653950949" => [
        "rules" => [
            "text" => "اهلاً وسهلاً بـ{mention}\nهذي قوانين القروب كاملة لابد تشيك عليها قبل إرسال أي شي داخل القروب واي مشكلة توجه للدعم!\n\n> • علماً في حال أرسلت شي بالقروب فأنت توافق على القوانين وجميع الشروط!",
            "button_text" => "⚖️ القوانين",
            "button_url" => "https://t.me/rjdjdjjIe/5"
        ]
    ],
...
if($text == "ذ" or $text == "ذكر" or $text == "." or $text == "اذكار"){
    ...
    if ($text == "تحداني") {
    $challenges = [
        "🧻 لف على القروب وقل (أنا عبقري) في كل رسالة",
        "💬 لا ترد على أحد لمدة ساعة",
        "🎤 غني بصوتك وأرسله (لو تقدر 😈)",
        "🤫 حاول ما تضحك خلال دقيقة (جرب)",
        "لاتكتب شي بالقروب لمده 3 دقايق هههههه"
    ];
    bot('sendMessage', [
        'chat_id' => $chat_id,
        'text' => "🔥 تحديك هو:\n" . $challenges[array_rand($challenges)]
    ]);
}
